...
import sys, os
# Loading the model
json_file = open(r"C:\Users\brije\Downloads\Controlling-Media-Player-with-Hand-Gestures-using-Convolutional-Neural-Network-main (2)\Controlling-Media-Player-with-Hand-Gestures-using-Convolutional-Neural-Network-main\gesture-model.json", "r")
model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(model_json)
# load weights into new model
loaded_model.load_weights(r"C:\Users\brije\Downloads\Controlling-Media-Player-with-Hand-Gestures-using-Convolutional-Neural-Network-main (2)\Controlling-Media-Player-with-Hand-Gestures-using-Convolutional-Neural-Network-main\gesture-model.h5")
